...
/**
 * Theme Configuration for the liftoff theme.
 *
...
$THEME->prescsscallback = 'theme_liftoff_get_pre_scss';

// This is a function that returns some SCSS as a string to prepend to the main SCSS file.                                          
$THEME->extrascsscallback = 'theme_liftoff_get_extra_scss';

/*$THEME->scss = function($theme) {                                                                                                   
    return theme_liftoff_get_main_scss_content($theme);                                                                               
};*/
