 ...
 * @copyright  2017 Willian Mano - conecti.me (Theme Moove)
 * @copyright  2019 Leicester College (Developer: Alan Ball)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
namespace theme_liftoff\output\core;
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        $content .= html_writer::link(new moodle_url('/course/view.php', array('id' => $course->id)),
            get_string('access', 'theme_liftoff'), array('class' => 'card-link btn btn-primary'));
