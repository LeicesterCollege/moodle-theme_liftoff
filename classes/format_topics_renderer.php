 ...
 * @copyright  2017 Willian Mano - http://conecti.me (From the Moove Theme)
 * @copyright  2019 Leicester College (Developer: Alan Ball)
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
defined('MOODLE_INTERNAL') || die();
require_once($CFG->dirroot . '/course/format/topics/renderer.php');

class theme_liftoff_format_topics_renderer extends format_topics_renderer {
    /**
    ...
    protected function section_summary($section, $course, $mods) {
        ...
        $output .= html_writer::start_tag('div', array('class' => 'inline-card'));
    ...
    protected function section_activity_summary($section, $course, $mods) {
        ...
        $output = '';
        $output.= html_writer::start_tag('div', array('class' => 'section-summary-activities text-center'));
        ...
        if ($total > 0) {
            ...
            if($percent > 0)
            {
                ...
                $output .= get_string('discipline_progress', 'theme_liftoff').": {$percent}%";
                $output .= "</div>";
            }
            else {
                $output .= "<div class='progress-bar-info text-center lec-no-progress' role='progressbar' aria-valuenow='{$percent}' aria-valuemin='0' aria-valuemax='100'>0% Progress</div>";
            }
            $output .= "</div>";
        }
